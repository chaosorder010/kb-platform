...
class DocumentSplitNode(BaseNode):
    ...
    def _split_by_headings(self, md_content: str, file_title: str) -> List[Dict[str, Any]]:
        ...
        heading_re = re.compile(r"^\s*(#{1,6})\s+(.+)") # 捕获组0：整个正则表达式的结果，group(1): 1-6个标题；group(2) 标题的内容，\s空格；+至少一个
...
if __name__ == '__main__':
    ...
    md_path = r"/home/leon/projects/-RAG-/eval/训练数据集/hak180产品安全手册.md"
    ...
    init_state = {
        ...
        "file_dir": r"/home/leon/projects/-RAG-/temp"
    }
