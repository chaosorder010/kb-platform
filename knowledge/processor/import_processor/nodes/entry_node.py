...
if __name__ == '__main__':
    ...
    init_state = {
        "import_file_path": r"/home/leon/projects/-RAG-/docs/万用表的使用_origin.pdf",
        ...
        "file_dir": r"/home/leon/projects/-RAG-/docs"
    }
    result = entry_node.process(init_state)

    print(f"is_pdf_read_enabled: {result.get('is_pdf_read_enabled')}")
    print(f"is_pdf_read_enabled: {result.get('is_md_read_enabled')}")
    print(f"file_tile: {result.get('file_title')}")
